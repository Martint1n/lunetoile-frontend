...
const Confidentialite = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg space-y-6">
      ...
      <h1 className="text-3xl font-bold  pb-4">Politique de Confidentialité</h1>
      ...
      <section className="space-y-4  pb-6">
        ...
        <p>LEMAIRE Arthur – Entrepreneur Individuel</p>
        <p>SIREN : 954 040 648</p>
        <p>Adresse : 9 Rue Pascal, 78470 Saint-Rémy-lès-Chevreuse, France</p>
        <p>Email de contact : arthur-bicyclette@live.fr</p>
      </section>

      <section className="space-y-4  pb-6">
        <h2 className="text-xl font-semibold">2. Données collectées</h2>
        <p>Lunétoile collecte uniquement les données strictement nécessaires au traitement des commandes. À ce jour, aucun système de cookies n’est activement utilisé à des fins de suivi statistique, publicitaire ou de profilage.</p>
      ...
      <section className="space-y-4  pb-6">
        ...
        <p>Pour exercer vos droits, écrivez à : arthur-bicyclette@live.fr</p>
      </section>
