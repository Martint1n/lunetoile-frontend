...
export default function Stripe({
  ...
  const makeTest = async () => {
    const response = await fetch(
      "https://lunetoile-backend.vercel.app/testpayment/testdb",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({}),
  ...
  return (
    <button
      ...
      className={`w-full xl:w-1/2 hover:bg-gold hover:text-black rounded-full font-montserrat font-bold flex items-center justify-center transition-all duration-300 px-8 py-4 whitespace-nowrap bg-gold text-black `}
    >
